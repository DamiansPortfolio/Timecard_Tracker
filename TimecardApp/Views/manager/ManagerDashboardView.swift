...
//                            value: "\(viewModel.pendingLeaveRequests.count)",
...
//                    NavigationLink(destination: PendingLeaveRequests(viewModel: viewModel, managerId: viewModel.managedEmployees.first?.id ?? "")) {
//                        QuickActionRow(
//                            title: "Manage Leave Requests",
//                            subtitle: "Review all submitted leave requests here",
//                            systemImage: "calendar.badge.clock"
//                        )
//                    }
//                    .background(.white)

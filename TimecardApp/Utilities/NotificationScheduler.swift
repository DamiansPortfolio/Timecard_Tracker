...
class NotificationScheduler {
    ...
    private func scheduleWorkStartReminder(hour: Int, minute: Int, advanceMinutes: Int) {
            // Schedule for each weekday (Monday = 2 through Friday = 6)
        for weekday in 2...6 {
            ...
            let request = UNNotificationRequest(identifier: "workStart-\(weekday)",
                                                content: content,
                                                trigger: trigger)
    ...
    private func scheduleWorkEndReminder(hour: Int, minute: Int, advanceMinutes: Int) {
        for weekday in 2...6 {
            ...
            let request = UNNotificationRequest(identifier: "workEnd-\(weekday)",
                                                content: content,
                                                trigger: trigger)
    ...
    private func scheduleBreakReminder(hour: Int, minute: Int, advanceMinutes: Int) {
        for weekday in 2...6 {
            ...
            let request = UNNotificationRequest(identifier: "break-\(weekday)",
                                                content: content,
                                                trigger: trigger)
    ...
    private func scheduleDailyTimecardReminder() {
        for weekday in 2...6 {
            ...
            let request = UNNotificationRequest(identifier: "dailyTimecard-\(weekday)",
                                                content: content,
                                                trigger: trigger)
